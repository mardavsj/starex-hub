...
const HomePage = () => {
  ...
  return (
    <div className="text-center items-center justify-center mt-16 py-5">
      ...
      <section className="text-base md:mt-20 mt-6 mb-5 md:p-1 p-5 items-center justify-center">
        ...
        <Link to="/signup" className="bg-primary/10 text-primary px-10 py-3 rounded-lg hover:bg-primary/20 font-bold">Get Started</Link>
      </section>
    </div>
  )
}
