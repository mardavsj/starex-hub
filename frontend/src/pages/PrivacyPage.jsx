...
const PrivacyPage = () => {
  ...
  useEffect(() => {
    document.title = 'Privacy Policy - StarX';
  }, []);
    ...
    <div className="py-28 md:px-0 px-3 mx-auto bg-primary/10">
      <div className="container mx-auto px-6 md:max-w-[60%]">
        ...
        <section className="md:text-md text-sm space-y-8">
          <p className="">
            At <strong>StarX</strong>, we value and respect the privacy of our users. This Privacy Policy outlines the types of personal information we collect and how we use, protect, and disclose that information. By using our services, you agree to the terms of this policy.
          </p>

          <h3 className="md:text-2xl text-xl font-semibold">1. Information We Collect</h3>
          <ul className="list-disc pl-8">
            <li><strong>Personal Information:</strong> When you sign up or interact with StarX, we collect personal details such as your name, email address, phone number, and any other information you provide during registration.</li>
            <li><strong>Usage Data:</strong> We collect information about your usage of StarX, including your interaction with the platform, your login history, and any communications with other users.</li>
            <li><strong>Device Information:</strong> We collect information about the device you use to access StarX, including browser type, IP address, operating system, and other technical details.</li>
          ...
          <ul className="list-disc pl-8">
            <li><strong>To Provide and Improve Our Services:</strong> We use your information to provide you with access to StarX, respond to your inquiries, and improve the functionality of the platform.</li>
          ...
          <ul className="list-disc pl-8">
            <li><strong>With Service Providers:</strong> We may share your data with trusted third-party vendors and service providers who assist in the operation of StarX, such as hosting services, analytics, and customer support.</li>
            ...
            <li><strong>In Case of Business Transactions:</strong> If StarX is involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction.</li>
          </ul>
          ...
          <ul className="list-disc pl-8">
            <li><strong>Access and Update:</strong> You have the right to access and update your personal information at any time by logging into your account on StarX.</li>
          ...
          <p>
            StarX is not intended for children under the age of 13. We do not knowingly collect personal information from children under the age of 13. If we become aware that we have collected information from a child under 13, we will take steps to delete that information from our system.
          </p>
